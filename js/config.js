...
var ajaxChatConfig = {
	...
	domIDs: {
		...
		// ID of the cell for name of first team
		name1: 'name1',
		// ID of the cell for name of second team
		name2: 'name2',
		// ID of the cell for score of first team
		score1: 'score1',
		// ID of the cell for score of second team
		score2: 'score2'
	},
