...
var ajaxChatLang = {
	...
	login: '%s vừa đăng nhập.',
	logout: '%s vừa đăng xuất.',
	logoutTimeout: '%s  (Timeout).',
	logoutIP: '%s has been logged out (Invalid IP address).',
	logoutKicked: '%s has been logged out (Kicked).',
	channelEnter: '%s gia nhập vào kênh.',
	channelLeave: '%s rời khỏi kênh.',
	privmsg: '(whispers)',
	...
	errorSpecatatorNotAllowed: 'Lỗi: Khán giả tạm thời không được phép chat public.',
	errorIncorrectSyntax: 'Lỗi: cú pháp lệnh sai',
