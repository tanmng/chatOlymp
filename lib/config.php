...
// Database username:
$config['dbConnection']['user'] = 'arena_user';
// Database password:
$config['dbConnection']['pass'] = 'mppozL2wo}^F';
// Database name:
$config['dbConnection']['name'] = 'arena_dbase';
// Database type:
...
$config['guestUserPrefix'] = 'KG_';
// Guest users should be distinguished by either a prefix or a suffix or both (no whitespace):
$config['guestUserSuffix'] = '';

/* Customize for arena.olympiavn.org */
$config['modNamePrefix']   = 'MOD_';
$config['modNameSuffix']   = '';
$config['adminNamePrefix'] = 'ADMIN_';
$config['adminNameSuffix'] = '';
...
$config['requestMessagesLimit'] = 40;
